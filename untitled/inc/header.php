            ...
            <div class="header-top">
                <div class="container">
                                ...
                                <div class="dropdownmenu-wrapper">
                                    <ul class="compare-products">
                                        <li class="product">
                                            ...
                                            <h4 class="product-name"><a href="shop/demo-shop-6-product-details.html">White top</a></h4>
                                        </li>
                                        <li class="product">
                                            <a href="#" class="btn-remove" title="Remove Product"><i class="fa fa-times"></i></a>
                                            <h4 class="product-name"><a href="shop/demo-shop-6-product-details.html">Blue Women Shirt</a></h4>
                                        </li>
                                    </ul>
                    ...
                    <div class="top-menu-area">
                        ...
                        <ul class="top-menu">
                            <li><a href="shop/demo-shop-6-myaccount.html">My Account</a></li>
                            <li><a href="#">Daily Deal</a></li>
                            <li><a href="#">My Wishlist</a></li>
                            <li><a href="shop/demo-shop-6-blog.html">Blog</a></li>
                            <li><a href="shop/demo-shop-6-login.html">Log in</a></li>
                        </ul>
                    </div>
                                    ...
                                    <div class="cart-dropdownmenu right">
                                        <div class="dropdownmenu-wrapper">
                                            <div class="cart-products">
                                                <div class="product product-sm">
                                                    ...
                                                    <div class="product-details-area">
                                                        <h2 class="product-name"><a href="shop/demo-shop-6-product-details.html" title="Product Name">Blue Women Top</a></h2>
                                                ...
                                                <div class="product product-sm">
                                                    ...
                                                    <div class="product-details-area">
                                                        <h2 class="product-name"><a href="shop/demo-shop-6-product-details.html" title="Product Name">Black Utility Top</a></h2>
                                            ...
                                            <div class="cart-actions">
                                                <a href="shop/demo-shop-6-cart.html" class="btn btn-primary">View Cart</a>
                                                <a href="shop/demo-shop-6-checkout.html" class="btn btn-primary">Checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
